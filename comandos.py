...
# Función para actualizar los recuentos en las etiquetas
def actualizar_recuentos(win_jug,win_bot,empates):
    etiqueta_victorias.clear()
    etiqueta_derrotas.clear()
    etiqueta_empates.clear()
    
    etiqueta_victorias.write(f"Victorias del jugador: {win_jug}", align="left", font=("Arial", 12, "normal"))
    etiqueta_derrotas.write(f"Victorias de la computadora: {win_bot}", align="left", font=("Arial", 12, "normal"))
    etiqueta_empates.write(f"Empates: {empates}", align="left", font=("Arial", 12, "normal"))
